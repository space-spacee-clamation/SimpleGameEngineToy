...
| `ADVANCED_PLAN.md` | 进阶专题规划（12 方向 57 课：碰撞策略 / 液体渲染 / 可破坏场景 / ECS / 手感 / 程序化生成等，已上线 26 课） |
...
| P9 | 毕业实战（阅读方法论 / 毕业项目） | ✅ |
| P10 | 进阶专题（CCD / 求解器 / 软体 PBD / 液体渲染 / 破坏 / 阴影 / 透明排序 / raymarching / mini-ECS 四部曲 / 地形 / 流式加载 / 粒子） | 🟡 已上线 26/57 |
