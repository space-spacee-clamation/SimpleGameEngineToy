...
| 阶段 | 主题 | 课 | 状态 |
|---|---|---|---|
| P0 | 引擎全景 | L0.1 用 100 行代码造一个「引擎」 ✅ · L0.2 引擎解剖图 | 1/2 |
| P1 | 时间与主循环 | L1.1 时间步长实验台 ✅ · L1.2 走读 Godot 的一帧 | 1/2 |
| P2 | 对象系统与架构模式 | L2.1 场景树 vs ECS · L2.2 Object/Variant/信号 · L2.3 内存管理 · L2.4 脚本绑定 | 0/4 |
| P3 | 数学与空间 | L3.1 变换与四元数 · L3.2 引擎数学库设计 | 0/2 |
| P4 | 渲染系统 | L4.1 GPU 管线+第一个三角形 · **L4.2 Shader 实验室（HLSL）✅** · L4.3 渲染器架构 · L4.4 后处理 | 1/4 |
| P5 | 物理系统 | **L5.1 空间网格 vs 暴力 ✅** · **L5.2 刚体求解 ✅** · L5.3 PhysicsServer 与 Jolt | 2/3 |
| P6 | 资源系统 | L6.1 资源与导入管线 | 0/1 |
| P7 | 玩法支撑 | L7.1 输入与 UI · L7.2 动画系统 · L7.3 音频系统 | 0/3 |
| P8 | 引擎级进阶 | L8.1 Job System · L8.2 网络同步 · L8.3 编辑器架构 | 0/3 |
| P9 | 毕业实战 | L9.1 大型 C++ 阅读方法论 · L9.2 毕业项目 | 0/2 |
...
以平台打卡为准（localStorage）。当前 ready：L0.1 / L1.1 / L4.2 / L5.1 / L5.2。
